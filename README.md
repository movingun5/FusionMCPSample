...
- **validate_drawing_modeling_plan**: Preflight stated, estimated, and missing dimensions from 1–3 principal drawing views and return a normalized plate or straight-profile tool call without changing Fusion
